...
import { db } from "@/db";
import { DBCollections, Subscriber } from "@/db/index.type";
...
export default function SubscriberEdit() {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      let data: Subscriber = await db.get(id);
    ...
    <div className="w-full flex h-full bg-gray-200">
      ...
      <div className="h-full flex flex-col w-full">
        ...
        <ScrollArea className="mt-5 p-3">
          <Card>
            <CardHeader>
              <CardTitle>Update Subscriber</CardTitle>
            </CardHeader>
            <CardContent>
              <Form {...form}>
...
SubscriberEdit.route = "/SubscriberEdit/:id";
