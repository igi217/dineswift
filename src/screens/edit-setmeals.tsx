...
const productSchema = z.object({
  ...
  product_id: z.string().min(1, { message: "You must select a Product" }),
  category_id: z.string().min(1, { message: "You must a select a Category" }),
...
const formSchema = z.object({
  ...
  is_setmeal: z.boolean(),
  other_products: z.array(productSchema),
});
export default function SetMealEdit() {
    ...
    <div className="w-full flex h-full bg-gray-200">
      ...
      <div className="h-full flex flex-col w-full">
        ...
        <ScrollArea className="mt-5 p-3">
          <Card>
            <CardHeader>
              <CardTitle>Edit Set-Meal</CardTitle>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  {fields.map((_item, index) => (
                    ...
                    >
                      <FormField
                        control={form.control}
                        name={`other_products.${index}.category_id`}
                        render={({ field }) => (
                            ...
                            <FormControl>
                              <Combobox
                                ...
                                onChange={(value) => {
                                  ...
                                  form.setValue(
                                    `other_products.${index}.category_name`,
                                    categoryName
                                  );
                                }}
                                options={categoryOptions}
                      ...
                      <FormField
                        control={form.control}
                        name={`other_products.${index}.product_id`}
                        render={({ field }) => (
                          <FormItem className="w-full">
...
SetMealEdit.route = "/SetMealEdit/:id";
